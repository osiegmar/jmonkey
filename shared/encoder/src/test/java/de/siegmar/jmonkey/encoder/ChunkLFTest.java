...
class ChunkLFTest {
    ...
    @Test
    void chunkLF() {
        final ChunkLF chunkLF = new ChunkLF(99);
        final BasicChunk encodedChunkLF = ChunkLFEncoder.encode(chunkLF);

        assertEquals(chunkLF, ChunkLFDecoder.decode(encodedChunkLF));
    }
