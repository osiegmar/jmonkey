...
class ChunkADTest {
    ...
    @ParameterizedTest
    @LecChunkSource(DataChunkType.AD)
    void readAD(final LecFile lecFile, final TreeIndex<LecChunk> adNode) {
        ChunkADDecoder.exportMidi(lecFile.readChunk(adNode.chunk()));
    }
