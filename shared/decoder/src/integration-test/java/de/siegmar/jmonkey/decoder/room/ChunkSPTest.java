...
class ChunkSPTest {
    ...
    @ParameterizedTest
    @LecChunkSource(DataChunkType.SP)
    void readSP(final LecFile lecFile, final TreeIndex<LecChunk> spNode) {
        final ColorPalette chunkSP = ChunkSPDecoder.readPalette(lecFile.readChunk(spNode.chunk()));
        assertThat(chunkSP.size()).isEqualTo(256);
    }
