...
public class PanCameraToOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x12, 0x92);

    public PanCameraToOpcode() {
        super(OPCODES);
    }
