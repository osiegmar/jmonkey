...
/**
 * Decoder for {@code actorFollowCamera} opcode (original: {@code camera-follow}).
 */
public class ActorFollowCameraOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x52, 0xD2);

    public ActorFollowCameraOpcode() {
        super(OPCODES);
    }
    ...
    public void doDecode(final int opcode, final EnhancedByteBuffer bb, final OpcodeDelegate opcodeDelegate) {
        ...
        opcodeDelegate.actorFollowCamera(actor);
    }
