...
public class SetObjectNameOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x54, 0xD4);

    public SetObjectNameOpcode() {
        super(OPCODES);
    }
    ...
    public void doDecode(final int opcode, final EnhancedByteBuffer bb, final OpcodeDelegate opcodeDelegate) {
        ...
        final ScummString name = getString(bb);
        opcodeDelegate.setObjectName(obj, name);
    }
