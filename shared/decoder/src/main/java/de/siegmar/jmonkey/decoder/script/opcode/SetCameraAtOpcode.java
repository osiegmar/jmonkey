...
public class SetCameraAtOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x32, 0xB2);

    public SetCameraAtOpcode() {
        super(OPCODES);
    }
