...
/**
 * Decoder for {@code setClass} opcode (original: {@code class-of}).
 */
public class ActorSetClassOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x5D, 0xDD);

    public ActorSetClassOpcode() {
        super(OPCODES);
    }
    ...
    public void doDecode(final int opcode, final EnhancedByteBuffer bb, final OpcodeDelegate opcodeDelegate) {
        ...
        final List<OpParameter> classes = readList16(bb);
        opcodeDelegate.setClass(obj, classes);
    }
