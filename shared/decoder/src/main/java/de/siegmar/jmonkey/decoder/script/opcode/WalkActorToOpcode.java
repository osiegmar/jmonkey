...
public class WalkActorToOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x1E, 0x3E, 0x5E, 0x7E, 0x9E, 0xBE, 0xDE, 0xFE);

    public WalkActorToOpcode() {
        super(OPCODES);
    }
    ...
    public void doDecode(final int opcode, final EnhancedByteBuffer bb, final OpcodeDelegate opcodeDelegate) {
        ...
        opcodeDelegate.walkActorTo(actor, x, y);
    }
