...
public class CutsceneOpcode extends AbstractOpcode {

    private static final Set<Integer> OPCODES = Set.of(0x40);

    public CutsceneOpcode() {
        super(OPCODES);
    }
