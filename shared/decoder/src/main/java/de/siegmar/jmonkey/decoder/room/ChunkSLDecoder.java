...
public final class ChunkSLDecoder {

    private ChunkSLDecoder() {
    }

    public static ChunkSL decode(final BasicChunk chunk) {
        Assert.assertEqual(chunk.header().name(), "SL");
        Assert.assertEqual(chunk.header().payloadLength(), 1);
